...
<div
    ...
    <form method="POST" action="{{ route('employee.destroy', $id) }}" class="h-[25px]">
        @csrf
        @method('DELETE')
        <p class="mb-5">Are you sure you want to <span class="text-red-300">delete</span> <strong> {{ $firstName }} {{ $lastName }}? </strong></p>
...
<tr class="border-t">
    ...
    <td scope="row" class="align-middle">
        <div class="flex flex-row justify-center gap-x-1">
            ...
            <a href="/employees/{{ $id }}?trigger=modal" class="btn text-accent h-[25px] w-[60px] p-1 border border-accent">Edit</a>
